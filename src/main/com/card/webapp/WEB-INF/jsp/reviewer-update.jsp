...
<!--<?php $this->layout->header_subpages() ?>-->
	...
	<div class="wrapper">
    	...
    	<ul class="nav nav-tabs main-views">
		 <li class="active"><a class="active-tab" href="redirect/LO_rev"><i class="icomoon-list"></i> Learning Objects</a></li>
		  ...
		  <li ><a  href="redirect/search_rev"><i class="icon-search icon-large search-tab"></i> Advanced Search</a></li>
		</ul>
