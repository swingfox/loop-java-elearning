...
$.extend( true, $.fn.dataTable.defaults, {
    ...
    "oLanguage": {
        "sLengthMenu": "<b style='font-weight: normal !important;'>Show</b>&nbsp;&nbsp;_MENU_",
        "sSearch": ""
    }
} );
...
//				);
                                $(nPaging).append(
					'<ul class="pagination">'+
					'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'"><i class="icon-double-angle-left"></i></a></li>'+
					'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'"><i class="icon-angle-left"></i></a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'"><i class="icon-angle-right"></i></a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'"><i class="icon-double-angle-right"></i></a></li>'+
					'</ul>'
				);
				var els = $('a', nPaging);
				var nFirst = els[0],
