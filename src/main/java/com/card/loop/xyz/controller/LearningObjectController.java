...
public class LearningObjectController {
    ...
    @Autowired
    LearningObjectService loService;
    @Autowired
    ...
    @ResponseBody
    public boolean acceptLO(@PathVariable String id) throws Exception {
    ...
    @ResponseBody
    public boolean demoteLO(@PathVariable String id) throws Exception {
        LearningObjectDto ud = new LearningObjectDto();
        boolean ok = false;
        ud.setId(id);
    ...
    @ResponseBody
    public boolean deleteLO(@PathVariable String id) throws Exception {
        LearningObjectDto ud = new LearningObjectDto();
        boolean ok = false;
        ud.setId(id);
