...
public class LearningElementController {
    @Autowired
    LearningElementService leService;
    @Autowired
    ...
    @ResponseBody
    public boolean acceptLE(@PathVariable String id) throws Exception {
    ...
    @ResponseBody
    public boolean demoteLE(@PathVariable String id) throws Exception {
        LearningElementDto ud = new LearningElementDto();
        ud.setId(id);
    ...
    @ResponseBody
    public boolean deleteLE(@PathVariable String id) throws Exception {
        LearningElementDto ud = new LearningElementDto();
        boolean ok = false;
        ud.setId(id);
