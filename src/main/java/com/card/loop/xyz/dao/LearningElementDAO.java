...
public class LearningElementDAO {
    ...
    public void addLearningElement(LearningElement object) throws IOException {
        this.addFile(object);
    }
    ...
    public boolean addFile(LearningElement le) throws IOException {
...
//	collection.insert(info, WriteConcern.SAFE);
    ...
    public boolean addFile(LearningElement le, File file) throws IOException {
        Mongo mongo = new Mongo(AppConfig.mongodb_host, AppConfig.mongodb_port);
        DB db = mongo.getDB(AppConfig.DATABASE_LOOP);
...
//	collection.insert(info, WriteConcern.SAFE);
    ...
    public void writePhysicalFile(String md5, String fileName) throws IOException {
        try {
