...
public class ContentShipper {
    ...
    public ContentShipper(HttpServletRequest request, HttpServletResponse response, boolean isContent) {
    ...
    public void ship(String filePath)
            throws IOException {
        ...
        // file object.
        File file = new File(filePath);//(basePath, URLDecoder.decode(requestedFile, "UTF-8"));
