...
<body ><!--?php echo (isset($status) && $status)?'onload=document.getElementById("responsive_changePassword_btn").click()':'' ?>-->	
	...
	<div class="wrapper">
    	...
    	<ul id="main-demo" class="nav nav-tabs main-views tour-step tour-step-two">
			...
			<li class="tour-step tour-step-three"><a href="redirect/uploadLO"><i class="icon-upload-alt icon-large default"></i> Upload LO</a></li>
			<li class="tour-step tour-step-three"><a href="redirect/uploadLE"><i class="icon-upload-alt icon-large default"></i> Upload LE</a></li>
			<!-- <li><a href="<?php //echo base_url()?>redirect/search"><i class="icomoon-search"></i> Advanced Search</a></li> -->
			<li class="tour-step tour-step-four"><a href="redirect/search"><i class="icon-search icon-large search-tab"></i> Advanced Search</a></li>
		</ul>
