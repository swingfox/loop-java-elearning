...
<body>	
	...
	<div class="wrapper">
    	...
    	<ul class="nav nav-tabs main-views">
			...
			<li><a class="active-tab" href="redirect/admin_view1"><i class="icon-folder-open icon-large default"></i> Developers</a></li>
		    ...
		    <li class="active"><a href="redirect/admin_view4"><i class="icon-ban-circle icon-large default"></i> Blocked Accounts</a></li>
